...
2. 「基幹システム」トップ画面の[マスタ設定]から「製品」マスタを選択して、[製品一覧]画面から「エクセル一括インポート」を選択します。

3. インポートするファイルを選択して、「開く」を選択します。

4. [インポート順の指定]({% link docs/product-registration/import-product/index.md%})を参考に設定を行い、「インポート」を選択します。

5. 「OK」を選択し、登録したい製品データの最左列に[更新]と表示されていることを確認します。  
